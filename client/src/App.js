...
export default function App() {
  const [tab, setTab] = useState('browse');        // 'browse' | 'search' | 'update'
  ...
  function switchTab(t) {
    setTab(t);
    if (t === 'browse') { setSelectedGroup(null); }
  }
        ...
        {tab === 'browse' && allPlants && selectedGroup && (
          <div className="group-detail">
            <div className="detail-header">
              ...
              <div className="sort-toggle">
                <button
                  ...
                  onClick={() => { setSortBy('botanical'); setBrowsePage(1); }}
                >Botanical</button>
                <button
                  className={sortBy === 'common' ? 'sort-btn active' : 'sort-btn'}
                  onClick={() => { setSortBy('common'); setBrowsePage(1); }}
                >Common</button>
              </div>
            </div>
            ...
            <div className="result-cards">
              {browseRows.map((r, i) => (
                <PlantCard key={i} r={r} sortBy={sortBy} />
              ))}
            </div>
          ...
          <div className="search-panel">
            <div className="search-bar-card">
              ...
              <div className="mode-buttons">
                <button className={searchBy === 'genus' ? 'mode-btn active' : 'mode-btn'} onClick={() => { setSearchBy('genus'); setQuery(''); }}>
                  Search by Genus
                </button>
                <button className={searchBy === 'common' ? 'mode-btn active' : 'mode-btn'} onClick={() => { setSearchBy('common'); setQuery(''); }}>
            ...
            {!debouncedQuery.trim() && (
              <div className="placeholder">
                ...
                <p>Type a genus or common name to find plants.</p>
              </div>
            )}
            ...
            {debouncedQuery.trim() && (
              <>
                ...
                {filtered.length === 0
                  ...
                  : <>
                    <div className="result-cards">
                      {searchRows.map((r, i) => <PlantCard key={i} r={r} sortBy="botanical" />)}
                    </div>
                    <div className="table-wrap">
                      <table className="results-table">
                        <thead>
                          <tr>
                            <th>Genus</th><th>Botanical Name</th><th>Common Name</th>
      ...
      <div className="update-steps">
        <div className="update-step">
          ...
          <div className="step-body">
            ...
            <p>Run your SQL query and export results as a JSON array with fields:
        ...
        <div className="update-step">
          ...
          <div className="step-body">
            ...
            <p>GitHub Actions rebuilds the site automatically. Refresh the app and the new data will be live.</p>
          </div>
        </div>
      </div>
    </div>
